export const formatCurrency = (amount: any, currency: string = 'TRY'): string => {
...
export const formatDate = (date: any, format: 'short' | 'long' | 'time' = 'short'): string => {
  if (!date) return '';
...
export const formatAddress = (address: {
  ...
  const parts = [address.street, address.district, address.city, address.country].filter(Boolean);
  return parts.join(', ');
};
