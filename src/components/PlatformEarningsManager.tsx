...
/**
 * BUSINESS ENTITY: Platform commission earned from completed shipments
 * YolNext earns a percentage of each successful shipment transaction
 * This is the core revenue model of the logistics marketplace
 */
interface PlatformEarningsRecord {
  id: number;                    // Unique earnings record ID
  shipment_id: number;          // Shipment that generated this earning
  price: number;                // Total shipment price (base for commission)
...
export default function CommissionManager({
  ...
  const [commissions, setCommissions] = useState<PlatformEarningsRecord[]>([]);
                      ...
                      <div className='flex items-center justify-between mt-4'>
                        ...
                        {commission.status === 'calculated' && (
                          <button
                            ...
                            className='px-4 py-2 bg-gradient-to-r from-slate-800 to-blue-900 text-white rounded-lg hover:from-blue-900 hover:to-slate-800 transition-colors text-sm font-medium'
                          >
                            İşle
                          </button>
                        )}
