  ...
  const menuSections = [
    {
      title: 'Ana Menü',
      items: [
        { name: 'Ana Sayfa', href: '/individual/dashboard', icon: User },
        ...
        { name: 'Teklifler', href: '/individual/offers', icon: FileText },
      ]
    },
    {
      title: 'Analiz & Raporlar',
      items: [
        { name: 'Analiz & Raporlar', href: '/individual/analytics', icon: BarChart3 },
      ]
    },
    {
      title: 'Destek',
      items: [
        ...
        { name: 'Yardım', href: '/individual/help', icon: HelpCircle },
      ]
    },
    {
      title: 'Hesap',
        ...
        <div className="p-3 lg:p-4 border-b border-slate-200">
          <div className="flex items-center gap-3 cursor-pointer hover:bg-slate-50 rounded-lg p-2 lg:p-3 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-xs lg:text-sm font-bold text-slate-900 truncate">Ahmet Yılmaz</div>
