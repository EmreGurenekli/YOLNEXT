...
const TasiyiciMyShipments: React.FC = () => {
  ...
  useEffect(() => {
    const loadShipments = async () => {
      try {
        console.log('🔄 Taşıyıcı gönderiler yükleniyor...');
        setLoading(true);
        ...
        if (response.ok) {
          ...
          console.log('✅ Taşıyıcı gönderiler yüklendi:', shipments.length);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Taşıyıcı gönderilerinizi takip edin ve yönetin'
        />
      </Helmet>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-slate-600'>
                Nakliyecilerden aldığınız gönderileri takip edin ve yönetin
              </p>
            </div>
            <Link
              to='/tasiyici/create-shipment'
            ...
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm text-slate-600'>
                  Nakliyecilerden Toplam Gönderi
                </p>
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <div className='flex-1'>
              <div className='relative'>
                ...
                <input
                  type='text'
                  placeholder='Nakliyeci gönderisi ara...'
                  value={searchTerm}
        ...
        <div className='bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden'>
          {filteredShipments.length === 0 ? (
            <div className='text-center py-12'>
              ...
              <h3 className='text-lg font-semibold text-slate-900 mb-2'>
                Nakliyeci gönderisi bulunamadı
              </h3>
              <p className='text-slate-600 mb-6'>
                Henüz nakliyecilerden gönderiniz bulunmuyor veya arama
                kriterlerinize uygun gönderi yok.
              </p>
              <Link
                to='/tasiyici/create-shipment'
...
export default TasiyiciMyShipments;
