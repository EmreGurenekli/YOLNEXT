...
const Item: React.FC<{ to: string; label: string }>
  = ({ to, label }) => (
  <Link
    to={to}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-slate-900 mb-6">Debug / Routes</h1>
        ...
        <Section title="Corporate">
          ...
          <Item to="/corporate/department-reporting" label="Department Reporting" />
        ...
        <Section title="Nakliyeci">
          ...
          <Item to="/nakliyeci/loads" label="Loads" />
          <Item to="/nakliyeci/offers" label="Offers" />
          <Item to="/nakliyeci/vehicle-optimization" label="Vehicle Optimization" />
          <Item to="/nakliyeci/notifications" label="Notifications" />
          <Item to="/nakliyeci/shipments" label="Shipments" />
          <Item to="/nakliyeci/carriers" label="Carriers" />
