...
const IndividualNotifications: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50'>
      <Helmet>
        <title>Bildirimler - YolNext Bireysel</title>
        <meta
          name='description'
          content='Bireysel gönderici bildirimleri - tüm bildirimlerinizi takip edin'
        />
      </Helmet>
      ...
      <div className='max-w-5xl mx-auto px-3 sm:px-4 py-4 sm:py-6'>
        ...
        <div className='text-center mb-8 sm:mb-12'>
          ...
          <p className='text-sm sm:text-base md:text-lg text-slate-600 px-4'>
            Tüm bildirimlerinizi tek yerden takip edin
          </p>
        </div>
                ...
                >
                  <div className='flex items-start space-x-4'>
                    <div className='flex items-center space-x-3'>
                      ...
                      />
                      <div
                        className={`w-10 h-10 rounded-lg flex items-center justify-center ${getNotificationColor(notification.type, notification.status)}`}
                      >
