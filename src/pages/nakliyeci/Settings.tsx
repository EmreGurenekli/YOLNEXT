...
export default function NakliyeciSettings() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-50">
      <Helmet>
        <title>Ayarlar - Nakliyeci Panel - YolNet</title>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
          <div className="flex items-center gap-3 mb-4 sm:mb-0">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Şirket ve uygulama ayarlarınızı yönetin</p>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                        ...
                        <button
                          onClick={() => handleToggle('business', 'autoAcceptJobs')}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            settings.business.autoAcceptJobs ? 'bg-slate-800' : 'bg-slate-200'
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                              settings.business.autoAcceptJobs ? 'translate-x-6' : 'translate-x-1'
                            }`}
                          />
                        </button>
                  </div>
                  <div>
                    ...
                    <input
                      type="number"
                          ...
                          onChange={(e) => handleInputChange('business', 'maxDistance', parseInt(e.target.value))}
                          className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-slate-500"
                        />
                      </div>
                      <div>
