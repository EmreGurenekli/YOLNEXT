...
router.post(
  ...
  [
    ...
    body('delivery_date')
      .isISO8601()
      .withMessage('Geçerli teslimat tarihi gerekli'),
    body('weight_kg')
      .isFloat({ min: 0 })
      .withMessage('Geçerli ağırlık gerekli'),
    body('budget_min')
      .isFloat({ min: 0 })
      .withMessage('Geçerli minimum bütçe gerekli'),
    body('budget_max')
      .isFloat({ min: 0 })
      .withMessage('Geçerli maksimum bütçe gerekli'),
  ],
  async (req, res) => {
    try {
