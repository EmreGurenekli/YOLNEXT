...
router.get('/profile', authenticateToken, requireUserType(['carrier']), async (req, res) => {
  try {
...
// Profil güncelleme
router.put('/profile', authenticateToken, requireUserType(['carrier']), async (req, res) => {
  try {
...
router.get('/wallet', authenticateToken, requireUserType(['carrier']), async (req, res) => {
  try {
...
// Cüzdan yükleme
router.post('/wallet/deposit', authenticateToken, requireUserType(['carrier']), async (req, res) => {
  try {
