...
const mockFAQs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Kredi kartı, banka kartı veya havale ile ödeme yapabilirsiniz. Ödeme işlemi güvenli SSL sertifikası ile korunmaktadır. Tüm ödemeler 3D Secure ile güvence altındadır.',
    category: 'payment',
    isPopular: true,
    helpful: 42,
    notHelpful: 3,
