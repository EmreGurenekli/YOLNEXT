...
router.get('/driver', authenticateToken, requireUserType(['driver']), async (req, res) => {
  try {
    ...
    const jobs = await Job.find(query)
      .populate('shipmentId', 'title fromLocation toLocation pickupDate deliveryDate')
...
router.get('/:id', authenticateToken, async (req, res) => {
  try {
    const job = await Job.findById(req.params.id)
      .populate('shipmentId', 'title fromLocation toLocation pickupDate deliveryDate specialRequirements')
...
router.put('/:id/status', authenticateToken, requireUserType(['driver']), async (req, res) => {
  try {
...
// Konum güncelleme
router.put('/:id/location', authenticateToken, requireUserType(['driver']), async (req, res) => {
  try {
